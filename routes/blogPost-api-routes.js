...
module.exports = (app) => {
  ...
  app.post("/api/BlogPosts/like", (request, response) => {
    const newLike = {
      ...
      //   UserId: request.user.id, TODO: add me back in and delete line below
      UserId: 2,
    };
    console.log("IM THE LIKE REQUEST------------------", request);
    console.log("IM THE LIKE REQUEST body------------------", request.body);
